    ...
    return (
        <div className="footer">
                ...
                <div className="row py-5 mt-5 g-3 border-bottom border-top text-center">
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-12">
                        <div >
                            ...
                            <p className=" text-muted">Any questions? Let us know in store at 8th floor, 41 Hay Al Irfan, Rabat, NY 10018 or call us on (+212) 6123456789</p>
            ...
            <div className="py-3 text-white text-center">
                <h6>Copy Right 2023 © All Rights Reserved</h6>
