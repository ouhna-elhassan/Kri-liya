        ...
        <div className="row g-4">
          ...
          <div className="col-md-4 col-sm-12 offset-md-1">
            <div className="d-flex align-items-center my-5">
              ...
              <div className="text">
                <h5 className="m-0 fw-bold">Rabt , Morocco.</h5>
                <p className="text-muted m-0">Hay al Irfan, CA 91770</p>
              </div>
            </div>
            <div className="d-flex align-items-center my-5">
              <i className="fa-solid fa-square-phone fs-2 me-3"></i>
              <div className="text ">
                <h5 className="m-0 fw-bold">+20123456789</h5>
            ...
            <div className="d-flex align-items-center my-5">
              ...
              <div className="text ">
                <h5 className="m-0 fw-bold">kriliya@gmail.com</h5>
            ...
            <div className="d-flex align-items-center my-5">
              ...
              <div className="text">
                <h5 className="m-0 fw-bold">Kri_Liya</h5>
                <p className="text-muted m-0">About us</p>
              </div>
            </div>
          </div>
        </div>
